...
class CommandSuggestion:
    ...
    action metadata used by tui's lightweight thread, skill, MCP, and mention
...
class TranscriptCell:
    ...
    # Fractional animation phase driven by a per-turn throughput estimator.
    # Finished scrollback metadata may only have ``chars_streamed``.
...
@dataclass
class PendingTurn:
    """A user message waiting behind the active tui turn."""
