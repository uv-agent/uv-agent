...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "BoundedText": (".threads", "BoundedText"),
    "CommandTextResult": (".textops", "CommandTextResult"),
    "ConversationMessage": (".threads", "ConversationMessage"),
    ...
    "ThreadCompaction": (".threads", "ThreadCompaction"),
    "ThreadCompactionSummary": (".threads", "ThreadCompactionSummary"),
    "ThreadDetailResult": (".threads", "ThreadDetailResult"),
    "ThreadDigest": (".threads", "ThreadDigest"),
    "ThreadDigestItem": (".threads", "ThreadDigestItem"),
    "ThreadEpoch": (".threads", "ThreadEpoch"),
    "ThreadTurn": (".threads", "ThreadTurn"),
    "ThreadView": (".threads", "ThreadView"),
    ...
    "thread_detail": (".threads", "thread_detail"),
    "thread_digest": (".threads", "thread_digest"),
    "thread_view": (".threads", "thread_view"),
